...
const PLANS: PlanInfo[] = [
  {
    ...
    role: "client",
    priceMonthly: 29.9,
    description: "Acesso completo ao portal do cliente e à análise preditiva de crédito.",
    features: [
  ...
  },
  {
    ...
    role: "broker",
    priceMonthly: 199,
    description: "Até 50 leads em andamento.",
    features: [
  ...
  },
  {
    ...
    role: "broker",
    priceMonthly: 499,
    description: "Até 200 leads em andamento.",
    features: [
      "Tudo do Corretor 50",
  ...
  },
  {
    ...
    role: "broker",
    priceMonthly: 0,
    description: "Acima de 200 leads — sob consulta.",
    features: [
      "Leads ilimitados",
  ...
  {
    id: "correspondent_50",
    label: "Correspondente 50",
    role: "correspondent",
    priceMonthly: 299,
    description: "Até 50 operações bancárias em andamento.",
    features: [
      "Gestão de documentação bancária",
      "Acompanhamento aprovação→chaves",
      "Etapas de engenharia e contrato",
      "Análise de crédito avançada",
    ],
    enterprise: false,
  },
  {
    ...
    label: "Correspondente 200",
    role: "correspondent",
    priceMonthly: 599,
    description: "Até 200 operações bancárias.",
    features: [
  ...
  },
  {
    ...
    role: "correspondent",
    priceMonthly: 0,
    description: "Acima de 200 operações — sob consulta.",
    features: [
...
export function ClientRegister() {
  ...
  const selectProfile = (p: ProfileId) => {
    ...
    const defaults: Record<Exclude<ProfileId, "admin">, string> = {
      client: "individual",
      broker: "corretor_50",
      correspondent: "correspondent_50",
    };
